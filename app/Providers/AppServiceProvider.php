...
use App\Infrastructure\Staff\EloquentServiceReader;
use App\Infrastructure\Staff\EloquentStaffReader;
...
class AppServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->bind(StaffReader::class, EloquentStaffReader::class);
        $this->app->bind(ServiceReader::class, EloquentServiceReader::class);
