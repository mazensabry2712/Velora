...
class AppServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->bind(CountryPriceSelector::class, PricingService::class);
        $this->app->bind(LandingSettingsReader::class, LegacyLandingSettingsReader::class);
        $this->app->bind(ReportReader::class, ReportService::class);
        $this->app->bind(TenantRegistrar::class, \App\Services\TenantRegistrationService::class);
