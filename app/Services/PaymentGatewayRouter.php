...
/**
 * Infrastructure-backed implementation of the payment gateway resolver.
 *
 * The domain depends on PaymentGatewayResolver rather than this concrete
 * service, so gateway selection can evolve without coupling business rules
 * to cache/Eloquent implementation details.
 */
