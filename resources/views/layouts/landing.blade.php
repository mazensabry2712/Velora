...
<footer class="v-footer"><div class="v-footer-inner"><img class="v-footer-ident" src="{{ asset('ident.png') }}" alt="Velora" /><div class="v-footer-meta">{{ date('Y') }} {{ $appName ?? config('app.name', 'Velora') }}. {{ __('landing.footer_rights') }}</div></div></footer>
</div>
<script>
