    ...
    <nav class="bg-white/95 dark:bg-[#0c0b18]/90 backdrop-blur-md shadow-sm border-b border-slate-200 dark:border-white/[0.07] sticky top-0 z-40" x-data="{ mobileOpen: false }">
                        ...
                        <div x-show="open" x-cloak @click.away="open = false"
                            ...
                            @php
                                $billingLinks = [
                                    ...
                                    ['route' => 'super-admin.country-pricing.index', 'label' => __('super-admin.nav_country_pricing'),                  'icon' => 'M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z'],
                                    ['route' => 'super-admin.promo-codes.index',     'label' => __('super-admin.nav_promo_codes'),                        'icon' => 'M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z'],
                                    ['route' => 'super-admin.upgrade-requests',      'label' => __('super-admin.nav_upgrade_requests'),                      'icon' => 'M7 11l5-5m0 0l5 5m-5-5v12'],
                                ];
                            @endphp
                            ...
                            <div class="mx-3 my-1 rounded-xl border border-slate-100 dark:border-slate-700 overflow-hidden">
                                ...
                                <div class="grid grid-cols-5 gap-1 p-2">
                                    @foreach($langNames as $code => $label)
                                        ...
                                        @else
                                            <span title="{{ $label }} ({{ __('super-admin.nav_language') }} unavailable)"
                                                  aria-disabled="true"
        ...
        <div x-show="mobileOpen" @click.away="mobileOpen = false" x-cloak
            ...
            <div class="px-4 pt-3 space-y-0.5">
                ...
                {{-- Billing group label --}}
                <p class="px-3 pt-3 pb-1 text-[10px] font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500">{{ __('super-admin.nav_billing') }}</p>
                @foreach([
                    ['route' => 'super-admin.subscription-plans',    'label' => __('super-admin.nav_subscriptions'), 'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2'],
                    ['route' => 'super-admin.country-pricing.index', 'label' => __('super-admin.nav_country_pricing'),                  'icon' => 'M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z'],
                    ['route' => 'super-admin.promo-codes.index',     'label' => __('super-admin.nav_promo_codes'),                        'icon' => 'M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z'],
                ...
                {{-- System group label --}}
                <p class="px-3 pt-3 pb-1 text-[10px] font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500">{{ __('super-admin.nav_system') }}</p>
                @foreach([
                    ['route' => 'super-admin.activity-logs',  'label' => __('super-admin.nav_logs'),          'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01'],
                    ['route' => 'super-admin.notifications',   'label' => __('super-admin.nav_notifications'), 'icon' => 'M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9'],
                    ['route' => 'super-admin.analytics',       'label' => __('super-admin.nav_analytics'),                         'icon' => 'M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z'],
