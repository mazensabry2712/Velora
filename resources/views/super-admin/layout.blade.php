...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Tajawal:wght@300;400;500;700;800;900&family=Plus+Jakarta+Sans:wght@400;500;600;700;800&display=swap"
        rel="stylesheet">
    ...
    <style>
        ...
        *,
        ...
        :not([lang='ar']) * {
            font-family: 'Plus Jakarta Sans', 'Tajawal', 'Inter', sans-serif;
        }
        ...
        *:focus-visible {
        ...
        .mobile-menu-open {
            animation: menuSlide 0.2s ease-out both;
        }
...
<body class="bg-slate-50 dark:bg-surface min-h-screen antialiased">
    ...
    <!-- Navigation -->
    <nav class="bg-white/95 dark:bg-[#0c0b18]/90 backdrop-blur-md shadow-sm border-b border-slate-200 dark:border-white/[0.07] sticky top-0 z-40"
            ...
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center gap-4">
                    <a href="{{ route('super-admin.dashboard') }}" class="flex items-center gap-3 group">
                        <div
                            class="w-10 h-10 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-xl flex items-center justify-center shadow-md group-hover:shadow-indigo-300 dark:group-hover:shadow-indigo-900 transition-shadow">
                        ...
                        <span class="text-xl font-bold gradient-text hidden sm:block"
                            style="font-family: 'Plus Jakarta Sans', sans-serif; letter-spacing: -0.01em">Super
                            Admin</span>
                    </a>
                </div>
                        ...
                        <div x-show="open" x-cloak @click.away="open = false"
                            ...
                            @php
                                $billingLinks = [
                                    [
                                        ...
                                        'label' => __('super-admin.nav_subscriptions'),
                                        'icon' =>
                                            'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2',
                                    ],
                                    [
                                        'route' => 'super-admin.country-pricing.index',
                                        'label' => __('super-admin.nav_country_pricing'),
                                        'icon' =>
                                            'M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
                                    ],
                                    [
                                        'route' => 'super-admin.promo-codes.index',
                                        'label' => __('super-admin.nav_promo_codes'),
                                        'icon' =>
                                            'M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z',
                                    ],
                                    [
                                        'route' => 'super-admin.upgrade-requests',
                                        'label' => __('super-admin.nav_upgrade_requests'),
                            ...
                            @foreach ($billingLinks as $link)
                                ...
                                <a href="{{ route($link['route']) }}" @click="open = false"
                                    ...
                                    <svg class="w-4 h-4 flex-shrink-0 {{ $isActive ? 'text-indigo-500' : 'text-slate-400' }}"
                            ...
                            @php
                                $systemLinks = [
                                    [
                                        ...
                                        'label' => __('super-admin.nav_logs'),
                                        'icon' =>
                                            'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01',
                                    ],
                                    [
                                        'route' => 'super-admin.notifications',
                                        'label' => __('super-admin.nav_notifications'),
                                        'icon' =>
                                            'M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9',
                                    ],
                                    [
                                        'route' => 'super-admin.analytics',
                                        'label' => __('super-admin.nav_analytics'),
                                        'icon' =>
                                            'M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z',
                                    ],
                                    [
                                        'route' => 'super-admin.settings',
                                        'label' => __('super-admin.nav_settings'),
                                        'icon' =>
                        ...
                        <div x-show="open" x-cloak @click.away="open = false"
                            ...
                            <div class="relative px-4 py-4 overflow-hidden">
                                <div class="absolute inset-0"
                                    style="background: linear-gradient(135deg, #4d3de3 0%, #6C63FF 60%, #8b76ff 100%)">
                                </div>
                                <div class="relative flex items-center gap-3">
                                    ...
                                    <div class="min-w-0">
                                        <p class="text-sm font-bold text-white leading-tight truncate">
                                            {{ auth()->user()->name }}</p>
                                        <p class="text-xs text-indigo-200 mt-0.5 truncate">{{ auth()->user()->email }}
                                        </p>
                                    </div>
                                    <span
                                        class="ms-auto flex-shrink-0 text-[10px] font-bold bg-white/25 text-white px-2.5 py-0.5 rounded-full border border-white/40 tracking-wide uppercase"
                            ...
                            <div class="px-3 pt-3 pb-1">
                                <a href="{{ route('super-admin.settings') }}"
                                    ...
                                    <div
                                        ...
                                        <svg class="w-4 h-4 text-slate-500 dark:text-slate-400 group-hover:text-indigo-600 dark:group-hover:text-indigo-400"
                                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="mx-3 my-1 rounded-xl border border-slate-100 dark:border-slate-700">
                                <div class="flex items-center justify-between px-3 py-2.5">
                                    <div class="flex items-center gap-2.5">
                                        ...
                                        <div
                                            class="w-8 h-8 rounded-lg bg-amber-50 dark:bg-indigo-900/50 flex items-center justify-center flex-shrink-0">
                                        ...
                                        <span
                                            class="text-sm font-medium text-slate-700 dark:text-slate-300">{{ __('super-admin.nav_toggle_mode') }}</span>
                                    </div>
                            ...
                            {{-- ── Language Grid ── --}}
                            <div
                                class="mx-3 my-1 rounded-xl border border-slate-100 dark:border-slate-700 overflow-hidden">
                                <div
                                    class="flex items-center justify-between px-3 py-2 border-b border-slate-100 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-700/30">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span
                                            class="text-xs font-semibold text-slate-400 uppercase tracking-wider">{{ __('super-admin.nav_language') }}</span>
                                    </div>
                                    <span
                                        class="text-[10px] font-bold text-indigo-600 dark:text-indigo-400 bg-indigo-100 dark:bg-indigo-900/50 px-2 py-0.5 rounded-full">
                                        {{ strtoupper($currentLang) }}
                                    </span>
                                </div>
                                @php
                                    // Only these languages are selectable; all others are shown disabled.
                                    $enabledLangs = ['en', 'ar'];
                                @endphp
                                <div class="grid grid-cols-5 gap-1 p-2">
                                    @foreach ($langNames as $code => $label)
                                        @if (in_array($code, $enabledLangs))
                                        ...
                                        @else
                                            <span
                                                title="{{ $label }} ({{ __('super-admin.nav_language') }} unavailable)"
                                                aria-disabled="true"
                                                class="flex items-center justify-center py-1.5 text-[11px] font-semibold rounded-lg text-slate-300 dark:text-slate-600 bg-slate-50/50 dark:bg-slate-800/30 cursor-not-allowed select-none opacity-60">
                                                {{ $label }}
                                            </span>
                                        @endif
                                    @endforeach
        ...
        <div x-show="mobileOpen" @click.away="mobileOpen = false" x-cloak
            ...
            <div class="px-4 pt-3 space-y-0.5">
                ...
                {{-- Billing group label --}}
                <p
                    class="px-3 pt-3 pb-1 text-[10px] font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500">
                    {{ __('super-admin.nav_billing') }}</p>
                @foreach ([['route' => 'super-admin.subscription-plans', 'label' => __('super-admin.nav_subscriptions'), 'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2'], ['route' => 'super-admin.country-pricing.index', 'label' => __('super-admin.nav_country_pricing'), 'icon' => 'M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z'], ['route' => 'super-admin.promo-codes.index', 'label' => __('super-admin.nav_promo_codes'), 'icon' => 'M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z'], ['route' => 'super-admin.upgrade-requests', 'label' => __('super-admin.nav_upgrade_requests'), 'icon' => 'M7 11l5-5m0 0l5 5m-5-5v12']] as $link)
                    @php $isActive = request()->routeIs($link['route']); @endphp
        ...
        ['route' => 'super-admin.analytics', 'label' => __('super-admin.nav_analytics'), 'icon' => 'M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z'],
        ...
        <div class="bg-white dark:bg-[#0c0b18] border-b border-slate-200 dark:border-white/[0.07]">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2.5">
                <nav class="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400">
                    <a href="{{ route('super-admin.dashboard') }}"
                        class="hover:text-indigo-600 dark:hover:text-indigo-400 transition flex items-center gap-1">
    ...
    <script>
        ...
        function showToast(message, type = 'success', duration = 3500) {
            ...
            toast.className =
                `toast-enter pointer-events-auto flex items-center gap-3 px-5 py-3.5 rounded-xl shadow-2xl text-white font-medium text-sm ${colors[type] || colors.success}`;
