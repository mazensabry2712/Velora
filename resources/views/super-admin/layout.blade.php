        ...
        <div x-show="mobileOpen" @click.away="mobileOpen = false" x-cloak
            ...
            <div class="px-4 pt-3 space-y-0.5">
                ...
                <p
                    ...
                    البلينج والأسعار</p>
                @foreach ([['route' => 'super-admin.subscription-plans', 'label' => __('super-admin.nav_subscriptions'), 'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2'], ['route' => 'super-admin.country-pricing.index', 'label' => 'الأسواق والأسعار', 'icon' => 'M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z'], ['route' => 'super-admin.promo-codes.index', 'label' => 'Promo Codes', 'icon' => 'M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z'], ['route' => 'super-admin.upgrade-requests', 'label' => 'طلبات الترقية', 'icon' => 'M7 11l5-5m0 0l5 5m-5-5v12']] as $link)
                    @php $isActive = request()->routeIs($link['route']); @endphp
