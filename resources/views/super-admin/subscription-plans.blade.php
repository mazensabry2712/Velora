            ...
            <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border-2 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <button @click="deletePlan(plan.id)" class="bg-red-50 dark:bg-red-900/30 hover:bg-red-100 dark:hover:bg-red-900/50 text-red-500 dark:text-red-400 p-2 rounded-xl transition">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
