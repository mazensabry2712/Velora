...
**{{ __('notifications.appointment_reminder.date', ['date' => $appointment->date->format('Y-m-d')], $locale) }}**
**{{ __('notifications.appointment_reminder.time', ['time' => $appointment->time_slot], $locale) }}**
