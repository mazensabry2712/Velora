...
return [
 ...
 'appointment_reminder'=>['subject'=>'予約リマインダー','greeting'=>':name さん、こんにちは。','message'=>'次回の予約についてのお知らせです。','details'=>'予約詳細：','date'=>'日付：:date','time'=>'時間：:time','service'=>'サービス：:service','staff'=>'担当者：:staff','tenant'=>'クリニック：:tenant','queue'=>'整理番号：:number','reference'=>'予約番号：:reference','tracking'=>'予約を確認：:url','footer'=>'ご来院をお待ちしています。','sms'=>'リマインダー：:tenant で :date :time に予約があります。'],
