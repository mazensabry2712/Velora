...
Route::middleware(['web', 'maintenance'])
    ...
    ->group(function () {
        ...
        Route::get('/lang/{locale}', function (\Illuminate\Http\Request $request, $locale) {
            ...
            $defaultLocale = config('localizer.omitted_locale', 'ar');
            $path = '/';
            ...
            if ($referer) {
                ...
                if (
                    ...
                    $refererUrl['host'] === $request->getHost() &&
...
Route::prefix('super-admin')
    ...
    ->group(function () {
        ...
        Route::middleware(['super.admin.auth'])->group(function () {
            ...
            Route::get('/promo-codes', [SuperAdminController::class, 'promoCodes'])->name('promo-codes.index');
            Route::post('/promo-codes', [SuperAdminController::class, 'storePromoCode'])->name('promo-codes.store');
            Route::patch('/promo-codes/{id}/toggle', [SuperAdminController::class, 'togglePromoCode'])->name('promo-codes.toggle');
            Route::delete('/promo-codes/{id}', [SuperAdminController::class, 'destroyPromoCode'])->name('promo-codes.destroy');
        });
    });
